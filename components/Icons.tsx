...
export const FamilyIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H9v-2a4 4 0 014-4h0a4 4 0 014 4v2zm-6 0h12" />
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 11c-2.485 0-4.5 2.015-4.5 4.5V19h9v-3.5c0-2.485-2.015-4.5-4.5-4.5zM3 21h18M5 21a2 2 0 104 0M15 21a2 2 0 104 0" />
  </svg>
);
...
export const CriminalIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 11c.052.27.09.546.09.833 0 2.21-1.79 4-4 4-1.598 0-2.969-.933-3.578-2.25M21 12c0 4.418-4.03 8-9 8s-9-3.582-9-8 4.03-8 9-8c.345 0 .684.02.998.058M17 9l-3 3-3-3" />
    </svg>
);

export const PropertyIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const ConsultIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a2 2 0 01-2-2V7a2 2 0 012-2h4M9 11h6" />
  </svg>
);
...
export const ScaleIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2h8a2 2 0 002-2v-1a2 2 0 012-2h1.945M7.8 9.928l-2.457-2.457A2 2 0 004 8.928V7a2 2 0 012-2h12a2 2 0 012 2v1.928a2 2 0 00-1.343.543l-2.457 2.457m-11.386 0L12 14.5l3.193-3.193" />
  </svg>
);
